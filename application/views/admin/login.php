            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user ajax-form" method="POST" action="/adminlogin/submit">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user required" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="/adminlogin/forgot_password">Forgot Password?</a>
                  </div>
                  <!--<div class="text-center">
